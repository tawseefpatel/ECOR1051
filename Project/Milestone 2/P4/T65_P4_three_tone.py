...
def three_toned(file: Image, colour1:str, colour2:str, colour3:str)-> Image:
    """returns a copy of an image in which there are only three colours (tones). If a pixel’s brightness is between 0 and 84, the corresponding pixel in the three-tone image is set to the first colour; for example, black. If a pixel's brightness is between 85 and 170, the corresponding pixel in the three-tone image is set to the second colour; for example, white. If a pixel's brightness is between 171 and 255, the corresponding pixel in the three-tone image is set to the third colour; for example, gray. """
...
#-------------------------------------------------------------------------------    
    ...
    for x,y, (r,g,b) in copied_image:
        ...
        if brightness <= 84: 
            ...
            three_tone_image = set_color(three_tone_copy, x,y, three_tone_colors)
